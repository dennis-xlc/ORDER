...
#ifdef ORDER
int is_in_DrlEMImpl_compileMethod[ORDER_THREAD_NUM] = { 0 };
int is_in_vm_compile_method[ORDER_THREAD_NUM] = { 0 };
#endif
...
JIT_Result DrlEMImpl::compileMethod(Method_Handle mh) {
    ...
    is_in_DrlEMImpl_compileMethod[tid1] = is_in_DrlEMImpl_compileMethod[tid1] + 1;
#endif
...
#ifdef ORDER_DEBUG
    is_in_vm_compile_method[tid1] = is_in_vm_compile_method[tid1] + 1;
#endif
    ...
    is_in_DrlEMImpl_compileMethod[tid2] = is_in_DrlEMImpl_compileMethod[tid2] - 1;
#endif
                    return JIT_SUCCESS;
                }
            }
