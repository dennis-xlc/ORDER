...
JNIEXPORT jboolean compareAndSetBooleanField
(JNIEnv * env, jobject UNREF accesor, jobject obj, jlong offset, jboolean expected, jboolean value, U_32 *old_val)
{
    assert(hythread_is_suspend_enabled());
    ObjectHandle h = (ObjectHandle)obj;
    ...
    U_8* java_ref = (U_8*)h->object;
    jboolean* field_addr = (jboolean*)(java_ref + offset);
    *old_val = (U_32)port_atomic_cas8((U_8*)field_addr, (U_8)value, (U_8)expected);
    bool result = ((U_8)*old_val == (U_8)expected);
...
JNIEXPORT jboolean compareAndSetIntField
(JNIEnv * env, jobject UNREF accesor, jobject obj, jlong offset, jint expected, jint value, jint *old_val)
{
    ...
    U_8* java_ref = (U_8*)h->object;
    jint* field_addr = (jint*)(java_ref + offset);
    *old_val = apr_atomic_cas32((U_32*)field_addr, (U_32)value, (U_32)expected);
    bool result = (*old_val == (U_32)expected);
...
JNIEXPORT jboolean compareAndSetLongField
(JNIEnv * env, jobject UNREF accesor, jobject obj, jlong offset, jlong expected, jlong value, jlong *old_val)
{
    assert(hythread_is_suspend_enabled());
    ObjectHandle h = (ObjectHandle)obj;
    ...
    *old_val = port_atomic_cas64((uint64*)field_addr, (uint64)value, (uint64)expected);
    bool result =  ((uint64)*old_val == (uint64)expected);

    tmn_suspend_enable();
    return (jboolean)(result?JNI_TRUE:JNI_FALSE);
}

JNIEXPORT void OrderCompareAndSetIntField
(JNIEnv * env, jobject UNREF accesor, jobject obj, jlong offset, jint expected, jint value, jint old_val)
{
    assert(hythread_is_suspend_enabled());
    ObjectHandle h = (ObjectHandle)obj;
    ...
    if(*field_addr != old_val){
        apr_atomic_set32((U_32*)field_addr, (U_32)old_val);
    }
