...
#ifdef ORDER //yzm
void (*gc_record_info)(Managed_Object_Handle p_obj) = 0;
void (*gc_add_thread_map_entry)(void* thread_structure) = 0;
void (*vm_initialize_end)() = 0;

U_8 (*gc_get_interleaving_info)(Managed_Object_Handle p_obj) = 0;
void (*gc_finalize_order)() = 0;

void (*gc_set_class_class)(void* class_class) = 0;

void (*gc_enter_method)(char* method_name, char* method_sig, char* class_name) = 0;

void (*gc_method_return)(char* method_name, char* method_sig, char* class_name) = 0;

//U_32 (*gc_enter_sleep)(Managed_Object_Handle obj) = 0;
//void (*gc_reset_sleep_flags)() = 0;
//void (*gc_reset_sleep_flag)(void* thread_struc) = 0;
//void (*gc_set_sleep_flag)(void* thread_struc) = 0;
#endif
...
#ifdef ORDER
    vm_initialize_end = (void (*)()) getFunction(handle, "vm_initialize_end", dllName);

    gc_record_info = (void (*)(Managed_Object_Handle p_obj)) getFunction(handle, "gc_record_info", dllName);
    gc_add_thread_map_entry = (void (*)(void* thread_structure)) getFunction(handle, "gc_add_thread_map_entry", dllName);
    gc_get_interleaving_info = (U_8 (*)(Managed_Object_Handle p_obj)) getFunction(handle, "gc_get_interleaving_info", dllName);
    gc_finalize_order = (void (*)()) getFunction(handle, "gc_finalize_order", dllName);

    gc_set_class_class = (void (*)(void* class_class)) getFunction(handle, "gc_set_class_class", dllName);
    gc_enter_method = (void (*)(char* method_name, char* method_sig, char* class_name)) getFunction(handle, "gc_enter_method", dllName);
    gc_method_return = (void (*)(char* method_name, char* method_sig, char* class_name)) getFunction(handle, "gc_method_return", dllName);
	
//    gc_enter_sleep = (U_32 (*)(Managed_Object_Handle obj)) getFunction(handle, "gc_enter_sleep", dllName);
//    gc_reset_sleep_flags = (void (*)()) getFunction(handle, "gc_reset_sleep_flags", dllName);
//    gc_reset_sleep_flag = (void (*)(void* thread_struc)) getFunction(handle, "gc_reset_sleep_flag", dllName);
//    gc_set_sleep_flag = (void (*)(void* thread_struc)) getFunction(handle, "gc_set_sleep_flag", dllName);
