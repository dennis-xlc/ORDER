...
{
#ifdef ORDER_DEBUG
    printf("[ENTER] : Java_java_lang_reflect_VMReflection_getExceptionTypes!!\n");
#endif
...
{
#ifdef ORDER_DEBUG
    printf("[ENTER] : Java_java_lang_reflect_VMReflection_getParameterTypes!!\n");
#endif
...
{
#ifdef ORDER_DEBUG
    printf("[ENTER] : Java_java_lang_reflect_VMReflection_getMethodReturnType!!\n");
#endif
    Method_Handle method = (Method_Handle) ((POINTER_SIZE_INT) member);
...
{
#ifdef ORDER_DEBUG
    printf("[ENTER] : Java_java_lang_reflect_VMReflection_getFieldType!!\n");
#endif
...
{
#ifdef ORDER_DEBUG
    printf("[ENTER] : rethrow_invocation_exception!!\n");
#endif
...
{
#ifdef ORDER_DEBUG
    printf("[ENTER] : invoke_primitive_method!!\n");
#endif
...
{
#ifdef ORDER_DEBUG
    printf("[ENTER] : Java_java_lang_reflect_VMReflection_invokeMethod!!\n");
#endif
...
{
#ifdef ORDER_DEBUG
    printf("[ENTER] : Java_java_lang_reflect_VMReflection_newArrayInstance!!\n");
#endif
...
{
#ifdef ORDER_DEBUG
    printf("[ENTER] : Java_java_lang_reflect_VMReflection_newClassInstance!!\n");
#endif
    Method_Handle method = (Method_Handle) ((POINTER_SIZE_INT) member);
