...
#ifdef ORDER
    bool is_entry_resolved(uint16 index, Class *klass) const ;
#endif
...
private:
  ...
  void* history_pool_pointer; //pionted to the access history pool
...
public:
	...
	U_32 get_hash_code() const {
        return m_hash_code;
    }

	void set_hash_code(U_32 hash_code){
