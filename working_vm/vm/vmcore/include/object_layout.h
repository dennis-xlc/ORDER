...
typedef struct ManagedObject {
    ...
    //1 Notice: Because this structure is not accessable in OPT, we have a dummy defination 
    //1 of this structure in: Ia32OrderRecordInstrumentation.cpp


    //yzm
    static unsigned counter_offset() { return (unsigned)(POINTER_SIZE_INT)(&((ManagedObject*)NULL)->access_count); }
#endif
