...
JNIEXPORT jboolean compareAndSetBooleanField
    (JNIEnv * env, jobject self, jobject obj, jlong offset, jboolean expected, jboolean value,  U_32 *old_val);


JNIEXPORT jboolean compareAndSetIntField
    (JNIEnv * env, jobject self, jobject obj, jlong offset, jint expected, jint value, jint *old_val);

JNIEXPORT jboolean compareAndSetLongField
    (JNIEnv * env, jobject self, jobject obj, jlong offset, jlong expected, jlong value, jlong *old_val);
