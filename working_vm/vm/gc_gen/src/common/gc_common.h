...
#ifdef ORDER_DEBUG
#define ORDER_GC_DEBUG//used for GC debug
#endif

extern bool order_record;
extern bool replay_verify;

enum MARK_TYPE{
  MARK_NIL, //NOT used
  MARK_IN_OI, // used in minor gc
  MARK_IN_VT, // used in major gc
  MARK_IN_VT_FORWARD //minor gc fail, need to check to object header to see if it is forwarded
};
