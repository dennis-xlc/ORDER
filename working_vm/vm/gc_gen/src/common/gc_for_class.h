...
FORCE_INLINE void set_obj_size_extend(Partial_Reveal_Object *obj) 
{  
#ifdef ORDER_DEBUG
    assert(obj);  
#endif
    obj->order_padding |= OBJ_SIZE_EXTEND; 
}

FORCE_INLINE bool obj_size_extend(Partial_Reveal_Object *obj) 
{  
#ifdef ORDER_DEBUG
    assert(obj); 
#endif
    return (obj->order_padding & OBJ_SIZE_EXTEND); 
}

FORCE_INLINE void reset_obj_size_extend(Partial_Reveal_Object *obj) 
{  
#ifdef ORDER_DEBUG
    assert(obj); 
#endif
...
FORCE_INLINE void set_obj_thread_local(Partial_Reveal_Object *obj) 
{  
#ifdef ORDER_DEBUG
    assert(obj);  
#endif
    obj->order_padding |= OBJ_THREAD_LOCAL; 
}

FORCE_INLINE bool obj_is_thread_local(Partial_Reveal_Object *obj) 
{  
#ifdef ORDER_DEBUG
    assert(obj); 
#endif
    return (obj->order_padding & OBJ_THREAD_LOCAL); 
}

FORCE_INLINE void reset_obj_thread_local(Partial_Reveal_Object *obj) 
{  
#ifdef ORDER_DEBUG
    assert(obj); 
#endif
