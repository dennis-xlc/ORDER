...
class VMInterface {
public:
    static bool         isFieldFinal(Class_Handle cl, U_16 index);
    static bool         isInitializing();
    static void*       getReplayAccessInfoMethod();
    static void*       getRecordAccessInfoMethod();
    static void*       getTIDAddress();
    static unsigned  getTIDOffset();
    static void*       printfAddr();
    static void*       vmEnterMethod();
    static void*       vmMethodReturn();
    static bool         vmOrderRecord();
    static void       vm_Record_System_Call_In_Compile(U_32 index, bool isUnresolved);
    static bool       vm_Get_System_Call_In_Compile(U_32 index);
    static bool       vm_is_lazy_resolution_enable();
    static bool       vm_is_show_parse_process();
#ifdef RECORD_STATIC_IN_FIELD
    static void*     getRecordFieldAccessInfoMethod();
#endif
//    static void*       vmEnterSleep();
    //
...
#ifdef THREAD_LOCAL_TAG
		bool 			isThreadLocal()  {return _isThreadLocal;}
		void			setThreadLocal(bool b) {_isThreadLocal = b;}
#endif
