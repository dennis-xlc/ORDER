...
public:
   ...
   Opnd* genTauVirtualCall(MethodDesc* methodDesc,//TR
    ...
    Opnd*      genLdElem(Type* elemType, Opnd* array, Opnd* index, bool isThreadLocal); //TR
    Opnd*      genLdElem(Type* elemType, Opnd* array, Opnd* index,
                         Opnd* tauNullCheck, Opnd* tauAddressInRange, bool isThreadLocal);
#else
...
#ifdef ORDER //yzm
    Opnd*      genLdStaticWithResolve(Type*, ObjectType* enclClass, U_32 cpIdx, Class_Handle clz);//TR
#else
	...
	void       genStElem(Type*, Opnd* array, Opnd* index, Opnd* src, bool isThreadLocal);//TR
    void       genStElem(Type*, Opnd* array, Opnd* index, Opnd* src,
                         Opnd* tauNullCheck, Opnd* tauBaseTypeCheck, Opnd* tauAddressInRange, bool isThreadLocal);
#else
...
#ifdef ORDER
    void       genStStaticWithResolve(Type*, ObjectType* enclClass, U_32 cpIdx, Opnd* src, Class_Handle clz);//TR
#else
    ...
    Opnd* genTauLdInd(Modifier mod, Type* type, Type::Tag ldType, Opnd* ptr, 
                       Opnd *tauBaseNonNull, Opnd *tauAddressInRange, FieldDesc* fieldDesc);
#endif

    Opnd* genTauLdInd(Modifier mod, Type *dstType, Type::Tag ldType, Opnd *ptr, //SI
                      Opnd *tauNonNullBase, Opnd *tauAddressInRange, Opnd* obj); // for simplifier use
    Opnd* genTauLdInd(Modifier mod, Type *dstType, Type::Tag ldType, Opnd *ptr, //SI
                      Opnd *tauNonNullBase, Opnd *tauAddressInRange, Class_Handle clz); // for simplifier use
...
#ifdef RECORD_STATIC_IN_FIELD
    void       genTauStInd(Type* type, Opnd* ptr, Opnd* src,
                       Opnd* tauBaseNonNull,  Opnd *tauAddressInRange,
                       Opnd* tauElemTypeChecked, FieldDesc* fieldDesc);
#endif

    void       genTauStInd(Type*, Opnd* ptr, Opnd* src,
                           Opnd *tauBaseNonNull, Opnd *tauAddressInRange,
                           Opnd *tauElemTypeChecked, Opnd* obj);
    void       genTauStInd(Type*, Opnd* ptr, Opnd* src,
                           Opnd *tauBaseNonNull, Opnd *tauAddressInRange,
                           Opnd *tauElemTypeChecked, Class_Handle clz);
#endif
...
#if defined(ORDER) && defined(THREAD_LOCAL_TAG)	
	void appendThreadLocalBit(Opnd* objOpnd);
#endif
