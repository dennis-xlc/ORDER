...
#ifdef THREAD_LOCAL_TAG
    void iastore(U_32 pc)  {}
    void lastore(U_32 pc)  {}
    void fastore(U_32 pc)  {}
    void dastore(U_32 pc)  {}
    void aastore(U_32 pc)  {}
    void bastore(U_32 pc)  {}
    void castore(U_32 pc)  {}
    void sastore(U_32 pc)  {}
#else
	void iastore()  {}
    void lastore()  {}
    void fastore()  {}
