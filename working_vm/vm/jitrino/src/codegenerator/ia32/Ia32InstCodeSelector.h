...
public:
    ...
    void           tau_stRef(CG_OpndHandle* src, CG_OpndHandle* ptr, CG_OpndHandle* base, Type::Tag memType, 
                             bool autoCompressRef, CG_OpndHandle* tauBaseNonNull,
                             CG_OpndHandle* tauAddressInRange, CG_OpndHandle* tauElemTypeChecked,
                             CG_OpndHandle* obj, Class_Handle clz, Field_Handle field);
#endif

    void           tau_stRef(CG_OpndHandle* src, CG_OpndHandle* ptr, CG_OpndHandle* base, Type::Tag memType, 
                             bool autoCompressRef, CG_OpndHandle* tauBaseNonNull,
                             CG_OpndHandle* tauAddressInRange, CG_OpndHandle* tauElemTypeChecked,
                             CG_OpndHandle* obj, Class_Handle clz);
#endif
    void           tau_stRef(CG_OpndHandle* src, CG_OpndHandle* ptr, CG_OpndHandle* base, Type::Tag memType, 
                             bool autoCompressRef, CG_OpndHandle* tauBaseNonNull,
                             CG_OpndHandle* tauAddressInRange, CG_OpndHandle* tauElemTypeChecked);
    ...
    CG_OpndHandle* newObj(ObjectType* objType, bool hasThreadLocalObj);     
    CG_OpndHandle* newArray(ArrayType* arrayType, CG_OpndHandle* numElems, bool hasThreadLocalObj);
    CG_OpndHandle* newMultiArray(ArrayType* arrayType, U_32 numDims, CG_OpndHandle** dims, bool hasThreadLocalObj);
#else
	...
	CG_OpndHandle* callvmhelper(U_32 numArgs, CG_OpndHandle** args, Type* retType,
                                VM_RT_SUPPORT callId, bool hasThreadLocalObj);
#else
    CG_OpndHandle* callvmhelper(U_32 numArgs, CG_OpndHandle** args, Type* retType,
...
private: 
...
#ifdef RECORD_STATIC_IN_FIELD
    Opnd *  convertIntToInt(Opnd * srcOpnd, Type * dstType, Opnd * dstOpnd, bool isZeroExtend, Opnd* obj, Class_Handle clz, Field_Handle field, bool isLoad);
    Opnd *  convertIntToFp(Opnd * srcOpnd, Type * dstType, Opnd * dstOpnd, Opnd* obj, Class_Handle clz, Field_Handle field, bool isLoad);
    Opnd *  convertFpToInt(Opnd * srcOpnd, Type * dstType, Opnd * dstOpnd, Opnd* obj, Class_Handle clz, Field_Handle field, bool isLoad);
    Opnd *  convertFpToFp(Opnd * srcOpnd, Type * dstType, Opnd * dstOpnd, Opnd* obj, Class_Handle clz, Field_Handle field, bool isLoad);
    Opnd*   convertUnmanagedPtr(Opnd * srcOpnd, Type * dstType, Opnd * dstOpnd, Opnd* obj, Class_Handle clz, Field_Handle field, bool isLoad);
    Opnd*   convertToUnmanagedPtr(Opnd * srcOpnd, Type * dstType, Opnd * dstOpnd, bool isZeroExtend, Opnd* obj, Class_Handle clz, Field_Handle field, bool isLoad);
#endif

    Opnd *  convertIntToInt(Opnd * srcOpnd, Type * dstType, Opnd * dstOpnd, bool isZeroExtend, Opnd* obj, Class_Handle clz, bool isLoad);
    Opnd *  convertIntToFp(Opnd * srcOpnd, Type * dstType, Opnd * dstOpnd, Opnd* obj, Class_Handle clz, bool isLoad);
    Opnd *  convertFpToInt(Opnd * srcOpnd, Type * dstType, Opnd * dstOpnd, Opnd* obj, Class_Handle clz, bool isLoad);
    Opnd *  convertFpToFp(Opnd * srcOpnd, Type * dstType, Opnd * dstOpnd, Opnd* obj, Class_Handle clz, bool isLoad);
    Opnd*   convertUnmanagedPtr(Opnd * srcOpnd, Type * dstType, Opnd * dstOpnd, Opnd* obj, Class_Handle clz, bool isLoad);
    Opnd*   convertToUnmanagedPtr(Opnd * srcOpnd, Type * dstType, Opnd * dstOpnd, bool isZeroExtend, Opnd* obj, Class_Handle clz, bool isLoad);
#endif
...
#ifdef ORDER
#ifdef RECORD_STATIC_IN_FIELD
    void    copyOpnd(Opnd *dst, Opnd *src, bool doZeroExtension, Opnd* obj, Class_Handle clz, Field_Handle field, bool isLoad);
    void    copyOpndTrivialOrTruncatingConversion(Opnd *dst, Opnd *src, Opnd* obj, Class_Handle clz, Field_Handle field, bool isLoad);
#endif
    void    copyOpnd(Opnd *dst, Opnd *src, bool doZeroExtension, Opnd* obj, Class_Handle clz, bool isLoad);
    void    copyOpndTrivialOrTruncatingConversion(Opnd *dst, Opnd *src, Opnd* obj, Class_Handle clz, bool isLoad);
#endif
...
#ifdef RECORD_STATIC_IN_FIELD
    Opnd * convert(CG_OpndHandle * oph, Type * dstType, Opnd * dstOpnd, bool isZeroExtend, Opnd* obj, Class_Handle clz, Field_Handle field, bool isLoad);
#endif

    Opnd * convert(CG_OpndHandle * oph, Type * dstType, Opnd * dstOpnd, bool isZeroExtend, Opnd* obj, Class_Handle clz, bool isLoad);
#endif
    ...
    CG_OpndHandle*      simpleLdInd(Type * dstType, Opnd *addr, Type::Tag memType,
                                    Opnd *baseTau, Opnd *offsetTau, Opnd* obj, Class_Handle clz, Field_Handle field);
#endif


    CG_OpndHandle*      simpleLdInd(Type * dstType, Opnd *addr, Type::Tag memType,
                                    Opnd *baseTau, Opnd *offsetTau, Opnd* obj, Class_Handle clz);

#ifdef RECORD_STATIC_IN_FIELD
    void                simpleStInd(Opnd *addr, Opnd *src, Type::Tag memType, 
                                    bool autoCompressRef, Opnd *baseTau, Opnd *offsetAndTypeTau, Opnd* obj, Class_Handle clz, Field_Handle field);
#endif
	
    void                simpleStInd(Opnd *addr, Opnd *src, Type::Tag memType, 
                                    bool autoCompressRef, Opnd *baseTau, Opnd *offsetAndTypeTau, Opnd* obj, Class_Handle clz);
#endif
    CG_OpndHandle*      simpleLdInd(Type * dstType, Opnd *addr, Type::Tag memType,
