...
public:
	...
	virtual CG_OpndHandle*  callvmhelper(U_32 numArgs, CG_OpndHandle** args, Type* retType,
                                       VM_RT_SUPPORT callId, bool hasThreadLocalObj) = 0;
#else
	virtual CG_OpndHandle*  callvmhelper(U_32 numArgs, CG_OpndHandle** args, Type* retType,
    ...
    virtual void           tau_stRef(CG_OpndHandle* src, CG_OpndHandle* ptr, CG_OpndHandle* base, Type::Tag memType, 
                             bool autoCompressRef, CG_OpndHandle* tauBaseNonNull,
                             CG_OpndHandle* tauAddressInRange, CG_OpndHandle* tauElemTypeChecked,
                             CG_OpndHandle* obj, Class_Handle clz, Field_Handle field) = 0;
#endif
...
#ifdef THREAD_LOCAL_TAG
    virtual CG_OpndHandle*  newObj(ObjectType* objType, bool hasThreadLocalObj) = 0; 
    virtual CG_OpndHandle*  newArray(ArrayType* arrayType, CG_OpndHandle* numElems, bool hasThreadLocalObj) = 0;
    virtual CG_OpndHandle*  newMultiArray(ArrayType* arrayType, U_32 numDims, CG_OpndHandle** dims, bool hasThreadLocalObj) = 0;
#else
