...
void JavaLabelPrepass::iaload(U_32 off)                            { genArrayLoad(int32Type, false); }
void JavaLabelPrepass::laload(U_32 off)                            { genArrayLoad(int64Type, false); }
void JavaLabelPrepass::faload(U_32 off)                            { genArrayLoad(singleType, false); }
void JavaLabelPrepass::daload(U_32 off)                            { genArrayLoad(doubleType, false); }
void JavaLabelPrepass::aaload(U_32 off)                            { genTypeArrayLoad(false); }
void JavaLabelPrepass::baload(U_32 off)                            { genArrayLoad(int32Type, false); }
void JavaLabelPrepass::caload(U_32 off)                            { genArrayLoad(int32Type, false); }
void JavaLabelPrepass::saload(U_32 off)                            { genArrayLoad(int32Type, false); }

void JavaLabelPrepass::iastore(U_32 off)                           { genArrayStore(int32Type, false);}
void JavaLabelPrepass::lastore(U_32 off)                           { genArrayStore(int64Type, false);}
void JavaLabelPrepass::fastore(U_32 off)                           { genArrayStore(singleType, false);}
void JavaLabelPrepass::dastore(U_32 off)                           { genArrayStore(doubleType, false);}
void JavaLabelPrepass::aastore(U_32 off)                           { genTypeArrayStore(false);}
void JavaLabelPrepass::bastore(U_32 off)                           { genArrayStore(int32Type, false);}
void JavaLabelPrepass::castore(U_32 off)                           { genArrayStore(int32Type, false);}
void JavaLabelPrepass::sastore(U_32 off)                           { genArrayStore(int32Type, false);}
#else
...
#ifdef THREAD_LOCAL_TAG
void JavaLabelPrepass::new_(U_32 constPoolIndex, U_32 pc)         { 
    StateInfo::SlotInfo slot;
    StateInfo::setNonNull(&slot);
...
void JavaLabelPrepass::newarray(U_8 etype, U_32 pc)                { 
    popAndCheck(int32Type);
...
void JavaLabelPrepass::anewarray(U_32 constPoolIndex, U_32 pc)    { 
    popAndCheck(int32Type); 
    StateInfo::SlotInfo slot;
    StateInfo::setNonNull(&slot);
    StateInfo::setExactType(&slot);
...
void JavaLabelPrepass::multianewarray(U_32 constPoolIndex, U_8 dimensions, U_32 pc) {
...
#ifdef THREAD_LOCAL_TAG
void JavaLabelPrepass::getfield(U_32 constPoolIndex, U_32 pc)
#else
...
#endif
{
    popAndCheck(A);//obj
#ifdef ORDER_DEBUG
    bool show_verbose_info = false;
    if(VMInterface::vm_is_show_parse_process()){
    ...
    if(show_verbose_info){
        printf("[GETFIELD]: the fdesc is NULL ? %d\n", fdesc == NULL ? 1 : 0);
    }
#endif
...
#ifdef ORDER_DEBUG
    if(show_verbose_info){
        printf("[GETFIELD]: the fieldType is NULL ? %d\n", fieldType == NULL ? 1 : 0);
    }
#endif
...
#ifdef THREAD_LOCAL_TAG
void JavaLabelPrepass::putfield(U_32 constPoolIndex, U_32 off) 
#else
...
#ifdef THREAD_LOCAL_TAG
void JavaLabelPrepass::genArrayLoad (Type *type, bool isThreadLocal)
#else
...
#ifdef THREAD_LOCAL_TAG
void JavaLabelPrepass::genTypeArrayLoad(bool isThreadLocal)
#else
...
#ifdef THREAD_LOCAL_TAG
void JavaLabelPrepass::genArrayStore(Type *type, bool isThreadLocal) 
#else
...
#ifdef THREAD_LOCAL_TAG
void JavaLabelPrepass::genTypeArrayStore(bool isThreadLocal) 
#else
