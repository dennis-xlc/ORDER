...
JavaByteCodeParserCallback::parseByteCode(const U_8* byteCodes,U_32 off) {
	...
	case 0x2e:    iaload(off);                       break;
    case 0x2f:    laload(off);                       break;
    // 0x3[0-f]
    case 0x30:    faload(off);                       break;
    case 0x31:    daload(off);                       break;
    case 0x32:    aaload(off);                       break;
    case 0x33:    baload(off);                       break;
    case 0x34:    caload(off);                       break;
    case 0x35:    saload(off);                       break;
#else
...
#ifdef THREAD_LOCAL_TAG	
    case 0x4f:    iastore(off);                      break;
    // 0x5[0-f]
    case 0x50:    lastore(off);                      break;
    case 0x51:    fastore(off);                      break;
    case 0x52:    dastore(off);                      break;
    case 0x53:    aastore(off);                      break;
    case 0x54:    bastore(off);                      break;
    case 0x55:    castore(off);                      break;
    case 0x56:    sastore(off);                      break;
#else
...
#ifdef THREAD_LOCAL_TAG
    case 0xb4:    getfield(su16(bcp+1), off);                 break;
    case 0xb5:    putfield(su16(bcp+1), off);                 break;
#else
    ...
    case 0xbb:
#ifdef THREAD_LOCAL_TAG
				  new_(su16(bcp+1),off);                      break;
#else
				  new_(su16(bcp+1));                          break;	
#endif
    case 0xbc:    
#ifdef THREAD_LOCAL_TAG
				  newarray(su8(bcp+1),off);                   break;
#else
				  newarray(su8(bcp+1));                       break;	
#endif	
    case 0xbd:    
#ifdef THREAD_LOCAL_TAG
				  anewarray(su16(bcp+1),off);                 break;
#else
				  anewarray(su16(bcp+1));                     break;	
#endif
    ...
    case 0xc5:    
#ifdef THREAD_LOCAL_TAG
		multianewarray(su16(bcp+1),su8(bcp+3),off);     break;
#else
		multianewarray(su16(bcp+1),su8(bcp+3));     break;
#endif
    case 0xc6:    
