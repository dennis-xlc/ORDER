...
protected:
    ...
    virtual void iaload(U_32 off) = 0;
    virtual void laload(U_32 off) = 0;
    virtual void faload(U_32 off) = 0;
    virtual void daload(U_32 off) = 0;
    virtual void aaload(U_32 off) = 0;
    virtual void baload(U_32 off) = 0;
    virtual void caload(U_32 off) = 0;
    virtual void saload(U_32 off) = 0;
#else
...
#ifdef THREAD_LOCAL_TAG
	virtual void iastore(U_32 off) = 0;
    virtual void lastore(U_32 off) = 0;
    virtual void fastore(U_32 off) = 0;
    virtual void dastore(U_32 off) = 0;
    virtual void aastore(U_32 off) = 0;
    virtual void bastore(U_32 off) = 0;
    virtual void castore(U_32 off) = 0;
    virtual void sastore(U_32 off) = 0;
#else
...
#ifdef THREAD_LOCAL_TAG
    virtual void getfield(U_32 constPoolIndex, U_32 pc) = 0;
    virtual void putfield(U_32 constPoolIndex, U_32 pc) = 0;
#else
...
#ifdef THREAD_LOCAL_TAG
    virtual void new_(U_32 constPoolIndex, U_32 pc) = 0;
    virtual void newarray(U_8 type, U_32 pc) = 0;
    virtual void anewarray(U_32 constPoolIndex, U_32 pc) = 0;
	virtual void multianewarray(U_32 constPoolIndex,U_8 dimensions, U_32 pc) = 0;
#else
