...
public:
	...
	void genArrayLoad (Type *type, bool isThreadLocal);
    void genTypeArrayLoad(bool isThreadLocal);
    void genArrayStore(Type *type, bool isThreadLocal);
    void genTypeArrayStore(bool isThreadLocal);
#else
...
#ifdef THREAD_LOCAL_TAG
    void iaload(U_32 off) ;
    void laload(U_32 off) ;
    void faload(U_32 off) ;
    void daload(U_32 off) ;
    void aaload(U_32 off) ;
    void baload(U_32 off) ;
    void caload(U_32 off) ;
    void saload(U_32 off) ;
#else
	void iaload() ;
    void laload() ;
    void faload() ;
...
#ifdef THREAD_LOCAL_TAG
    void iastore(U_32 off) ;
    void lastore(U_32 off) ;
    void fastore(U_32 off) ;
    void dastore(U_32 off) ;
    void aastore(U_32 off) ;
    void bastore(U_32 off) ;
    void castore(U_32 off) ;
    void sastore(U_32 off) ;
#else
	void iastore() ;
    void lastore() ;
    void fastore() ;
...
#ifdef THREAD_LOCAL_TAG
	void getfield(U_32 constPoolIndex, U_32 pc) ;
    void putfield(U_32 constPoolIndex, U_32 pc) ;
#else
...
#ifdef THREAD_LOCAL_TAG
    void new_(U_32 constPoolIndex, U_32 pc) ;
    void newarray(U_8 type, U_32 pc) ;
    void anewarray(U_32 constPoolIndex, U_32 pc) ;
	void multianewarray(U_32 constPoolIndex,U_8 dimensions, U_32 pc) ;
#else
