...
#ifdef ORDER
    //yzm
unsigned obj_info_offset() { return (unsigned)(POINTER_SIZE_INT)(&((ManagedObjectDummy*)NULL)->obj_info); }
unsigned alloc_tid_offset() { return (unsigned)(POINTER_SIZE_INT)(&((ManagedObjectDummy*)NULL)->alloc_tid); }
unsigned alloc_count_offset() { return (unsigned)(POINTER_SIZE_INT)(&((ManagedObjectDummy*)NULL)->alloc_count); }
#endif
