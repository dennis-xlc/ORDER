...
U_32 pthreadid_tid_mapping[100][2];


FILE *threadRunOrderFile = NULL;
U_32 p_tid = -1;
U_32 p_count = -1;

int hythread_isRecord;
int hythread_vm_is_initializing = TRUE;
void VMCALL hythread_vm_initialize_end()
{
    hythread_vm_is_initializing = FALSE;
}

void VMCALL hythread_set_IsRecord(int isRecord)
{
    hythread_isRecord = isRecord;
}

int VMCALL hythread_get_IsRecord(void)
{
    return hythread_isRecord;
}
#endif
