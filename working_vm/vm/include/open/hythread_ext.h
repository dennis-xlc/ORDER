...
#ifdef ORDER
void VMCALL hythread_vm_initialize_end(void);
void VMCALL hythread_set_IsRecord(int isRecord);
int VMCALL hythread_get_IsRecord(void);
#endif
...
/*
#ifdef ORDER
IDATA VMCALL hythread_global_strong_lock_order();
IDATA VMCALL hythread_global_strong_unlock_order();
hythread_iterator_t VMCALL hythread_iterator_create_order(hythread_group_t group);
IDATA VMCALL hythread_iterator_release_order(hythread_iterator_t *it);
#endif
*/
