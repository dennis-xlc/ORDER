...
DECLARE_OPEN(void, record_System_Call_In_Compile, (U_32 constPoolIndex, bool isUnresolved));
DECLARE_OPEN(bool, get_System_Call_In_Compile, (U_32 constPoolIndex));

DECLARE_OPEN(bool, is_field_final, (Class_Handle cl, U_16 index));

DECLARE_OPEN(bool, is_initializing, ());

DECLARE_OPEN(void*, get_tm_self_tls_addr, ());

DECLARE_OPEN(unsigned, get_tid_offset, ());

DECLARE_OPEN(void*, get_replay_access_info_method, ());

DECLARE_OPEN(void*, get_record_access_info_method, ());

DECLARE_OPEN(void*, vm_enter_method, ());
DECLARE_OPEN(void*, vm_method_return, ());

DECLARE_OPEN(bool, vm_is_record, ());

DECLARE_OPEN(void*, printf_addr, ());

DECLARE_OPEN(bool, is_lazy_resolution_enable, ());
DECLARE_OPEN(bool, is_show_parse_process, ());

//DECLARE_OPEN(void*, vm_enter_sleep, ());
#ifdef RECORD_STATIC_IN_FIELD
DECLARE_OPEN(void*, get_record_field_access_info_method, ());
#endif
