...
#ifdef ORDER//yzm
GCExport void gc_record_info(Managed_Object_Handle p_obj);
GCExport void gc_add_thread_map_entry(void* thread_structure);
GCExport void vm_initialize_end();


GCExport U_8 gc_get_interleaving_info(Managed_Object_Handle p_obj);
GCExport void gc_finalize_order();

GCExport void gc_add_thread_map_entry(void* gc_set_class_class);
GCExport void gc_enter_method(char* method_name, char* method_sig, char* class_name);
GCExport void gc_method_return(char* method_name, char* method_sig, char* class_name);

//GCExport U_32 gc_enter_sleep(Managed_Object_Handle obj);
//GCExport void gc_reset_sleep_flags();
//GCExport void gc_reset_sleep_flag(void* thread_struc);
//GCExport void gc_set_sleep_flag(void* thread_struc);
#endif
...
#ifdef ORDER//yzm
VMEXPORT extern void (*gc_record_info)(Managed_Object_Handle p_obj);
VMEXPORT extern void (*gc_add_thread_map_entry)(void* thread_structure);
VMEXPORT extern void (*vm_initialize_end)();

VMEXPORT extern U_8 (*gc_get_interleaving_info)(Managed_Object_Handle p_obj);
VMEXPORT extern void (*gc_finalize_order)();

VMEXPORT extern void (*gc_set_class_class)(void* class_class);
VMEXPORT extern void (*gc_enter_method)(char* method_name, char* method_sig, char* class_name);
VMEXPORT extern void (*gc_method_return)(char* method_name, char* method_sig, char* class_name);

//VMEXPORT extern U_32 (*gc_enter_sleep)(Managed_Object_Handle obj);
//VMEXPORT extern void (*gc_reset_sleep_flags)();
//VMEXPORT extern void (*gc_reset_sleep_flag)(void* thread_struc);
//VMEXPORT extern void (*gc_set_sleep_flag)(void* thread_struc);
#endif
