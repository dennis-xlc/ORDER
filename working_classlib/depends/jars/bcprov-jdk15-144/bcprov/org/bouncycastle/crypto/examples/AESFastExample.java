...
public class AESFastExample
{
    ...
    public static void main(String args[])
    {
        ...
        if(args.length < 2)
        {
            AESFastExample desexample = new AESFastExample();
        ...
        AESFastExample desexample1 = new AESFastExample(s, s1, s2, flag);
        desexample1.process();
    }

    public AESFastExample()
    {
        encrypt = true;
        cipher = null;
        in = null;
    ...
    public AESFastExample(String s, String s1, String s2, boolean flag)
    {
        encrypt = true;
        cipher = null;
        in = null;
