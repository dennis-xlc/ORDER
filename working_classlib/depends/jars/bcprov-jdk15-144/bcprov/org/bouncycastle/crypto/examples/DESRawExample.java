...
public class DESRawExample
{
    ...
    public static void main(String args[])
    {
        ...
        if(args.length < 2)
        {
            DESRawExample desexample = new DESRawExample();
        ...
        DESRawExample desexample1 = new DESRawExample(s, s1, s2, flag);
        desexample1.process();
    }

    public DESRawExample()
    {
        encrypt = true;
        cipher = null;
        in = null;
    ...
    public DESRawExample(String s, String s1, String s2, boolean flag)
    {
        encrypt = true;
        cipher = null;
        in = null;
